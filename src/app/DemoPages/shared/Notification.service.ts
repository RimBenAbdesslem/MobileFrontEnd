...
export class NotificationService {
  ...
  readonly UrlUserTrue = 'https://localhost:44369/api/ApplicationUser/All';
  readonly UrlUserFalse = 'https://localhost:44369/api/ApplicationUser/AllUsers';

  readonly urlrole = 'https://localhost:44369/api/ApplicationUser/GetRole';
  ...
  getAllUsersTrue() {
    return this.http.get("https://localhost:44369/api/ApplicationUser/All")
    .toPromise().then(
      res=>{
  ...
  refreshList1() {
    this.http.get(this.rootURL + '/ApplicationUser/All')
    .toPromise()
    .then(res => this.usersTrue = res as Users[]);
  }
  refreshListRole(id) {
    this.http.get('https://localhost:44385/api/ApplicationUser/GetRole/' + id)
    .toPromise()
    .then(res => this.role = res as Role[]);
  }
  refreshList() {
    this.http.get(this.rootURL + '/ApplicationUser/All')//false
      .toPromise()
  ...
  deletePaymentDetail(id) {
    console.log(id);
    return this.http.delete('https://localhost:44369/api/ApplicationUser/' + id);
  }
